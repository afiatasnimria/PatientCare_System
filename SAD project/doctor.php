...
$displayName = 'Doctor';
$displayRoleEn = 'Doctor';
$displayRoleBn = 'ডাক্তার';
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="user-profile-nav">
                        <img id="headerAvatar" src="<?php echo htmlspecialchars(!empty($photo) ? $photo : 'https://randomuser.me/api/portraits/men/33.jpg'); ?>" alt="User" class="user-avatar-nav">
                        <div class="user-info-nav">
                            ...
                            <p><span class="lang-text en">Doctor</span><span class="lang-text bn">ডাক্তার</span></p>
                        </div>
                        <div class="dropdown">
    ...
    <aside class="sidebar" id="sidebar" aria-label="Main navigation">
        ...
        <nav>
            <ul class="sidebar-menu">
                ...
                <li><a href="profile.php"><i class="fas fa-user"></i> <span class="lang-text en">Profile</span><span class="lang-text bn">প্রোফাইল</span></a></li>
        ...
        <div class="content-section">
            ...
            <div class="earnings-summary">
                <div class="earnings-item">
                    <div class="earnings-value">৳45,000</div>
                ...
                <div class="earnings-item">
                    <div class="earnings-value">৳3,200</div>
        ...
        <div class="content-section">
            ...
            <ul class="appointment-list">
                <li class="appointment-item">
                    <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Patient" class="appointment-patient">
                    <div class="appointment-details">
                        <div class="appointment-patient-name"><span class="lang-text en">Fatima Rahman</span><span class="lang-text bn">ফাতেমা রহমান</span></div>
                        <div class="appointment-info"><i class="fas fa-clock"></i> <span class="lang-text en">9:00 AM - 9:30 AM</span><span class="lang-text bn">সকাল ৯:০০ - সকাল ৯:৩০</span></div>
                        <div class="appointment-info"><i class="fas fa-stethoscope"></i> <span class="lang-text en">Follow-up</span><span class="lang-text bn">ফলো-আপ</span></div>
                    </div>
                    <div class="appointment-actions">
                        <button class="appointment-action-btn btn-view"><span class="lang-text en">View</span><span class="lang-text bn">দেখুন</span></button>
                        <button class="appointment-action-btn btn-prescribe"><span class="lang-text en">Prescribe</span><span class="lang-text bn">প্রেসক্রাইব</span></button>
                    </div>
                </li>
                <li class="appointment-item">
                    <img src="https://randomuser.me/api/portraits/men/67.jpg" alt="Patient" class="appointment-patient">
                    <div class="appointment-details">
                        <div class="appointment-patient-name"><span class="lang-text en">Mohammad Ali</span><span class="lang-text bn">মোহাম্মদ আলী</span></div>
                        <div class="appointment-info"><i class="fas fa-clock"></i> <span class="lang-text en">10:00 AM - 10:30 AM</span><span class="lang-text bn">সকাল ১০:০০ - সকাল ১০:৩০</span></div>
                        <div class="appointment-info"><i class="fas fa-stethoscope"></i> <span class="lang-text en">New Patient</span><span class="lang-text bn">নতুন রোগী</span></div>
                    </div>
                    <div class="appointment-actions">
                        <button class="appointment-action-btn btn-view"><span class="lang-text en">View</span><span class="lang-text bn">দেখুন</span></button>
                        <button class="appointment-action-btn btn-prescribe"><span class="lang-text en">Prescribe</span><span class="lang-text bn">প্রেসক্রাইব</span></button>
                ...
                <li class="appointment-item">
                    <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Patient" class="appointment-patient">
                    <div class="appointment-details">
                        <div class="appointment-patient-name"><span class="lang-text en">Nusrat Jahan</span><span class="lang-text bn">নুসরাত জাহান</span></div>
                        <div class="appointment-info"><i class="fas fa-clock"></i> <span class="lang-text en">11:00 AM - 11:30 AM</span><span class="lang-text bn">সকাল ১১:০০ - সকাল ১১:৩০</span></div>
                        <div class="appointment-info"><i class="fas fa-stethoscope"></i> <span class="lang-text en">Consultation</span><span class="lang-text bn">পরামর্শ</span></div>
                    </div>
                    <div class="appointment-actions">
                        <button class="appointment-action-btn btn-view"><span class="lang-text en">View</span><span class="lang-text bn">দেখুন</span></button>
                        <button class="appointment-action-btn btn-prescribe"><span class="lang-text en">Prescribe</span><span class="lang-text bn">প্রেসক্রাইব</span></button>
